      ...
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1.3fr),minmax(280px,0.7fr)]">
        <div className="glass-panel rounded-[2rem] border border-white/50 editorial-shadow px-5 py-4 sm:px-6 sm:py-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <Link
              to={`/app/${slug}/lessons`}
              className="liquid-glass-card rounded-[1.25rem] px-4 py-3 text-slate-900 cursor-pointer transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] no-underline"
            >
            ...
            <Link
              to={`/app/${slug}/vocabulary`}
              className="liquid-glass-card rounded-[1.25rem] px-4 py-3 shadow-[inset_0_0_0_1px_rgba(148,163,184,0.16)] cursor-pointer transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] no-underline"
            >
          ...
          <div className="mt-3 liquid-glass-card rounded-[1.75rem] border border-white/60 px-4 py-3 sm:px-5 sm:py-3">
            <div className="flex items-center justify-between gap-2 mb-3">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-slate-400 text-sm" aria-hidden="true">menu_book</span>
            ...
            <div className="space-y-1.5">
              <p className="text-sm text-slate-400 text-center py-6">No lessons loaded yet. Connect to the API to populate your lesson library.</p>
            </div>
          </div>
        </div>
        <div className="liquid-glass-panel rounded-[2rem] p-5 sm:p-6 editorial-shadow">
          ...
          <div className="flex items-center gap-3">
            <div className="lesson-profile-avatar h-14 w-14 rounded-2xl border border-white/10 flex items-center justify-center bg-gradient-to-br from-sky-500 to-indigo-600">
              <span className="material-symbols-outlined text-white text-2xl" aria-hidden="true">person</span>
            </div>
            <div className="min-w-0">
              <p className="font-label text-[10px] font-bold uppercase tracking-[0.24em] text-slate-500">Student Snapshot</p>
              <p className="font-headline text-xl leading-tight text-slate-900">Welcome!</p>
              <p className="mt-1 text-sm text-slate-600 truncate">Student: {slug || '—'}</p>
              <span className="mt-2 inline-flex items-center rounded-full bg-white/30 px-3 py-1 text-[10px] font-label font-bold uppercase tracking-[0.2em] text-slate-700">Loading…</span>
            </div>
          </div>
          <div className="mt-3 space-y-1.5 text-sm leading-relaxed text-slate-700">
            <p>Your dashboard will populate with lesson progress, vocabulary stats, and quiz scores once connected to the backend.</p>
          </div>
        </div>
      </div>
    </div>
