...
export default function WordFlashcards3D({front,back,flipped,onFlip,onMark}:{front:string;back:string;flipped:boolean;onFlip:()=>void;onMark:(mark:'known'|'review')=>void}){
 ...
 return <Stage accent="#ba20ff" secondary="#00f0aa" title="Memory vault" instruction="Open the vault card to recall its meaning. Route the opened card to a memory archive." width={12} height={9}>
