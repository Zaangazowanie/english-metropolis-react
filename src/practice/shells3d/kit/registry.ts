...
export const game3dRegistry: Game3DRegistryEntry[] = [
  ...
  },
  {
    ...
    title: 'Flip the Pairs',
    district: 'The Memory Cellar',
    load: () => import('../Concentration3D'),
  },
  {
    shellKey: 'opencloze',
    title: 'Ink the Page',
  ...
  },
  {
    ...
    title: 'Key-Word Rewrite',
    district: "The Translator's Booth",
    load: () => import('../SentenceTransform3D'),
  },
  {
    shellKey: 'wordsearch',
    title: 'Hunt the Word',
    district: 'Neon Market',
    load: () => import('../Wordsearch3D'),
  },
  {
    shellKey: 'typingtest',
    title: 'Tap the Dispatch',
    district: 'The Telegraph Office',
    load: () => import('../TypingTest3D'),
  },
