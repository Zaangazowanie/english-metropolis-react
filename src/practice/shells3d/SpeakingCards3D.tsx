...
const design = { kind: 'studio', title: 'Bajla Broadcast Studio', instruction: 'Use the microphone console to record, stop and self-rate your spoken response. Your own honest assessment completes the card.', action: 'Broadcast', color: '#ff2370', mode: 'direct' } as const;
