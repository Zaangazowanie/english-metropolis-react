...
const design = { kind: 'reactor', title: 'The Quiz Reactor', instruction: 'Power up a round, aim at an answer core, then release the charge before the timer expires.', action: 'Release charge', color: '#ffcc00', mode: 'choice' } as const;
