        ...
        {round.options.map((opt, oi) => {
          ...
          return (
            <div key={oi} style={{
              ...
              border: `1px solid ${showCorrect ? '#22C55E88' : showWrong ? '#ff387188' : 'rgba(245,239,255,0.1)'}`,
              color: showCorrect ? '#22C55E' : showWrong ? '#ff3871' : 'var(--em-text, #EDE6FF)',
...
export const SnakeShell: React.FC<SnakeShellProps> = ({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      snakeRef.current = moved; setSnake(moved);
    };
