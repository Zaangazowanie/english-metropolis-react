#!/bin/bash
# Connect returning WhatsApp students and authenticate Bajla chat; frontend-only release.
set -euo pipefail
umask 022
REPO=/root/englishmetro
WEB=/var/www/englishmetro
BASE=564881d7fe5eb8cf98a1ca8429f0c001c82f37ab
STAMP=$(date -u +%Y%m%d-%H%M%S)
BACKUP=/root/backups/englishmetro-bajla-welcome-$STAMP
. "$(dirname "$0")/_guard.sh"
guard_clean_prod "$REPO"
cd "$REPO"
exec 9>/root/englishmetro-bajla-welcome-deploy.lock
flock -n 9
...
cp -a "$WEB/students/conversa-widget-v5.js" "$BACKUP/conversa-widget-v5.js"
...
rollback() {
  ...
  install -m 644 "$BACKUP/conversa-widget-v5.js" "$WEB/students/conversa-widget-v5.js"
...
PY
install -m 644 public/students/conversa-widget-v5.js "$WEB/students/.conversa-$STAMP.js"
mv "$WEB/students/.conversa-$STAMP.js" "$WEB/students/conversa-widget-v5.js"
...
PY
curl --fail --silent --show-error --max-time 30 'https://englishmetro.com/students/conversa-widget-v5.js?v=bajla-access-20260908' > "$BACKUP/edge-widget.js"
cmp public/students/conversa-widget-v5.js "$BACKUP/edge-widget.js"
trap - ERR
echo "Bajla welcome and account connection published at $REV. Evidence: $BACKUP"
